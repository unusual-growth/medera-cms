...
.header__item.s--on, .header__item:hover{
    background-color: transparent !important;
}

.header__item.s--on a, .header__item:hover a{
    color: #f44336;
}
.header__item {
    color:#333;
...
.header__item::before {
    content: "►";  /* You can change this symbol to anything you want */
    position: absolute;
    left: 0px;
    top: 50%;
...
.headerSearch__toggle .icon{color: #fff;}
.headerSearch__toggle .icon:hover{color: #ccc;}

.listing,#content,.fieldset,.publisher__wrapper{
    background: #fff;
...
.a17.a17--login {
  ...
  background: -webkit-linear-gradient(to right, #6496b6, #e4e5e6); /* Chrome 10-25, Safari 5.1-6 */
  background: linear-gradient(to right, #6496b6, #e4e5e6); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
