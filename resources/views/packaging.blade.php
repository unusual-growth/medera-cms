...
@section('content')
        ...
        <div class="container xlarge">
            <div class="row justify-space-between">
                <div class="col-md-5">
                    ...
                    requirements. Whether in bulk quantities or capsule form, branded or unbranded, we deliver our butyrate
    ...
    $packagingTypes = [
        [
            ...
            'description' => 'Compact bagging options simplify storage and logistics processes, reducing workload.  ',
        ],
        [
            'icon' => '/dummy-img/peach-fab-icon.svg',
            'title' => 'Product Quality',
            'description' => 'Butyrates are packaged in special food-grade bags to ensure freshness and quality until they reach your customers as a product. ',
        ],
        [
            'icon' => '/dummy-img/peach-fab-icon.svg',
            'title' => 'Sustainability',
            'description' => 'Our packaging system minimizes packaging waste, fostering an environmentally friendly approach. ',
        ],
    ];
@endphp
    ...
    <div class="container xlarge journey-container">
        ...
        <div class="journey-content col-sm-7">
            <div>
                ...
                <p>To maximize the bioavailability of your gut butyrate products, we boost their effectiveness using acid-resistant, plant-based DRcaps® capsules. Our butyrate supplements prepared in DRcaps® capsules offer a ready-to-use solution for consumers.</p>
            </div>
        </div>
    </div>
</section>
...
$packagingTypes = [
    ...
    [
        ...
        'title' => 'Hygiene',
        'description' =>
            'It ensures maximum hygiene reliability by securely preserving the product. ',
    ],
    [
        'icon' => '/dummy-img/mini-img.png',
        'title' => 'Consumer Reach',
        'description' =>
            'The capsule formulation expands the product’s appeal to a broader consumer base.',
    ],
    [
        'icon' => '/dummy-img/mini-img.png',
    ...
    <div class="container xlarge">
        <div class="row justify-space-between">
            <div class="col-md-5">
                ...
                <p>We carefully store the gut butyrates we formulate for our business partners, tailored for your needs, and deliver them to you by filling them into bottles under hygienic conditions. We extend the shelf life of your products while preserving their active components for longer. With easy-to- open and -close caps of the bottles, we enhance portability and make daily use more convenient.  </p>
            </div>
...
<section class="banner">
    <div class="container xlarge">
        <div class="row justify-content-center">
            <p>Purchase your butyrates in bottles and extend their shelf life.</p>
        </div>
    </div>
</section>
...
$packagingTypes = [
    [
        ...
        'title' => 'Saving',
        'description' =>
            'Products are delivered shelf-ready, saving time and effort.',
    ],
    [
        'icon' => '/dummy-img/mini-img.png',
        'title' => 'Standard Quality',
        'description' =>
            'Consolidated production and packaging ensure consistent quality standards. ',
    ],
    [
        'icon' => '/dummy-img/mini-img.png',
        'title' => 'Speed',
        'description' =>
            'Shelf-ready packaging optimizes storage processes and accelerates deliveries. ',
    ],
    [
        'icon' => '/dummy-img/mini-img.png',
        'title' => 'Cost-effectiveness',
        'description' =>
            'Managing all processes under one roof offers an economical solution.',
    ],
