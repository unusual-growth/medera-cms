...
class HowWeWorkController extends BaseModuleController
{
    protected $moduleName = 'howWeWorks';
    /**
     * This method can be used to enable/disable defaults. See setUpController in the docs for available options.
     */
    protected function setUpController(): void
    {
        $this->setPermalinkBase(permalinkBase: 'how-we-work');
    ...
    public function getCreateForm(): Form
    {
        return Form::make([
            ...
            Select::make()
                ->name('template')
                ->label('Template')
                ->options(HowWeWork::getTemplateOptions())
                ->default(HowWeWork::DEFAULT_TEMPLATE),
            Input::make()
                ->name('slug')
